...
(2, '完成阶段任务', '今天完成了前后端联调，页面可以正常请求后端接口，感觉很有成就感。', '有成就感', 'positive', '开心', 4, '联调,进展,成就感', '用户因为项目推进顺利产生积极情绪。', '可以记录下今天有效的学习和开发方法，作为后续推进项目的参考。', '2026-05-30 00:00:00', '2026-05-30 10:00:00', '2026-05-30 10:00:00'),
(2, '准备论文材料', '今天整理毕设文档时有些焦虑，担心后面的功能来不及完成。', '焦虑', 'negative', '焦虑', 3, '毕设,论文,进度', '用户对毕业设计进度存在担忧，但情绪强度中等。', '建议拆分下一步任务，先完成最核心功能，再逐步补充展示和优化内容。', '2026-05-29 00:00:00', '2026-05-29 21:30:00', '2026-05-29 21:30:00'),
(3, '平静的一天', '今天按计划学习和休息，没有特别大的情绪波动，整体比较平稳。', '平静', 'neutral', '平静', 2, '学习,休息,平稳', '用户当天情绪平稳，生活节奏较规律。', '可以继续保持稳定作息，并适当加入运动或放松活动。', '2026-05-30 00:00:00', '2026-05-30 20:00:00', '2026-05-30 20:00:00');
